...
<div class="dashboard-container">
    <div class="dashboard-header">
      <h1 class="dashboard-title">Registered Users Addresses</h1>
...
<% 
	...
	try {
			...
			<tr>
              ...
              <td><%= rs.getLong("alphoneno") %></td>
              <td><%= rs.getLong("pincode") %> </td>
              <td><%= rs.getString("state") %></td>
              <td><%= rs.getString("locality") %></td>
              <td><%= rs.getString("city") %></td>
              <td><%= rs.getString("address") %></td>
              <td><div class="remvp"><a href="removeuaddress.jsp?id=<%=rs.getString("emailid")%>">  <button class="cancel">Remove User</button></a></div></td>
