        ...
        <div class="product-right">
            ...
            <div class="offers-section">
                ...
                <div class="offer-item">
                    <div class="offer-icon">•</div>
                    <div class="offer-text">
                        <strong>Bank Offer:</strong> 0% instant discount on SBI Credit Card EMI Transactions, up to ₹1,500 on orders of ₹5,000 and above
                        <a href="#" class="tnc-link">T&C</a>
                    </div>
                </div>
                </div>
                <div class="offer-item">
                    <div class="offer-icon">•</div>
                    <div class="offer-text">
                        <strong>Bank Offer:</strong> 10% off up to ₹1,250 on all Axis Bank Credit Card (incl. migrated ones) EMI Txns of ₹7,499 and above
                        <a href="#" class="tnc-link">T&C</a>
                    </div>
                </div>
...
<% 
	...
	try {
				...
				Class.forName("com.mysql.cj.jdbc.Driver");
				Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/india_mart","root","jarvis");
				PreparedStatement pst = con.prepareStatement("SELECT * FROM addproduct WHERE pid REGEXP '^fashion' ORDER BY RAND() LIMIT 12;");
			ResultSet rs =	pst.executeQuery();
		...
		<div class="maincon2">		
			<div class="product-grid" id="productGrid">
                  ...
                  <a href="fashion_det.jsp?id=<%=rs.getString("pid")%>">  
