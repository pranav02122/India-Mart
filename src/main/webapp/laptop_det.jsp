...
<nav class="navbar">
    ...
    <div class="search-container">
      <input type="text" class="search-bar" placeholder="Search any product">
      <button  class="btns"  >
...
<% 
	...
	try {
				...
				Class.forName("com.mysql.cj.jdbc.Driver");
				Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/india_mart","root","jarvis");
				PreparedStatement pst = con.prepareStatement("SELECT * FROM addproduct WHERE pid REGEXP '^laptop' ORDER BY RAND() LIMIT 12;");
			ResultSet rs =	pst.executeQuery();
		...
		<div class="maincon2">		
			<div class="product-grid" id="productGrid">
                  ...
                  <a href="laptop_det.jsp?id=<%=rs.getString("pid")%>">  
