...
<% 
	...
	try {
				...
				Class.forName("com.mysql.cj.jdbc.Driver");
				Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/india_mart","root","jarvis");
				PreparedStatement pst = con.prepareStatement("SELECT * FROM addproduct WHERE pid REGEXP '^watch' ORDER BY RAND() LIMIT 12;");
			ResultSet rs =	pst.executeQuery();
		...
		<div class="maincon2">		
			<div class="product-grid" id="productGrid">
                  ...
                  <a href="watch_det.jsp?id=<%=rs.getString("pid")%>">  
