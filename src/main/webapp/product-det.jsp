        ...
        <div class="product-right">
            ...
            <div class="offers-section">
                ...
                <div class="offer-item">
                    <div class="offer-icon">•</div>
                    <div class="offer-text">
                        <strong>No cost EMI ₹5,333/month.</strong> Standard EMI also available
...
<% 
	...
	try {
				...
				Class.forName("com.mysql.cj.jdbc.Driver");
				Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/india_mart","root","jarvis");
				PreparedStatement pst = con.prepareStatement("SELECT * FROM addproduct WHERE pid REGEXP '^smartphone' ORDER BY RAND() LIMIT 12;");
			ResultSet rs =	pst.executeQuery();
		...
		<div class="maincon2">		
			<div class="product-grid" id="productGrid">
                  ...
                  <a href="product-det.jsp?id=<%=rs.getString("pid")%>">  
